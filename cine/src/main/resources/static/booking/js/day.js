...
$(document).ready(function() {
	...
	for (var i = 0; i < 15; i++) { // 0부터 13까지 총 14일
		...
		// 버튼 요소를 생성하고 속성을 설정
		var buttonHtml = '<button class='+dayClass+' type="button" date-data="2023.10.13" month="9">' +
			'<span class="ir">'+year+'년 '+month+'월</span>' +
			'<em style="pointer-events:none;">'+day+'<span style="pointer-events:none;" class="ir">일</span></em>' +
