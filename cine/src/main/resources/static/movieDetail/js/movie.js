    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $.each(data, function(index, item) {
				...
				+" <a href=\"/movieDetail/movie-detail2?title="+item.title+"\" class=\"wrap movieBtn\" data-no=\"23075200\" "
				...
				+"<div class=\"rate-date\"> <span class=\"rate\">예매율 32%</span> <span class=\"date\">"+"개봉일 "+ item.opendate.substring(0, 10)+"</span>"
