...
public class UserInfo {
	...
	@RequestMapping("/kakaoemail")
	public String getkakao(@ModelAttribute MemberEntity entity,HttpSession session) throws ClassNotFoundException, SQLException {
		String kakaoEm = (String) session.getAttribute("kakaoemail");
